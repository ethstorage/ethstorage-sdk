...
class EthStorage {
    ...
    async estimateCost(key, data) {
        ...
        const hexKey = ethers.keccak256(stringToHex$1(key));
...
export { BlobUploader, Download, EthStorage, decodeBlob, decodeBlobs, encodeBlobs, getChainId, stringToHex$1 as stringToHex };
