...
class FlatDirectory {
    ...
    async init(rpc, address) {
        ...
        if (address) {
            const provider = new ethers.ethers.JsonRpcProvider(rpc);
            const fileContract = new ethers.ethers.Contract(address, FlatDirectoryAbi, provider);
    ...
    async deploy() {
        ...
        const factory = new ethers.ethers.ContractFactory(FlatDirectoryAbi, contractByteCode, this.#wallet);
        try {
...
exports.ETHSTORAGE_MAPPING = ETHSTORAGE_MAPPING;
exports.EthStorage = EthStorage;
exports.EthStorageAbi = EthStorageAbi;
exports.FlatDirectory = FlatDirectory;
exports.FlatDirectoryAbi = FlatDirectoryAbi;
exports.MAX_BLOB_COUNT = MAX_BLOB_COUNT;
exports.PaddingPer31Bytes = PaddingPer31Bytes;
